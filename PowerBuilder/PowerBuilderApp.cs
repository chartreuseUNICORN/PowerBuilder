...
namespace PowerBuilder
{
    public class PowerBuilderApp : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication a)
        {
            ...
            PushButtonData pbdC2 = new PushButtonData("cmd2-test","Command2", thisAssemblyPath, "PowerBuilder.Command2");
            PushButtonData pbdC3 = new PushButtonData("cmd3-test", "Command3", thisAssemblyPath, "PowerBuilder.Command3");
