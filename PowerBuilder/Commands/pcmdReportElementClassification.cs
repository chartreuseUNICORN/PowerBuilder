...
namespace PowerBuilder.Commands
{
    ...
    public class pcmdReportElementClassification : IPowerCommand {
        public string DisplayName { get; } = "Report Element Classification";
          ...
          ElementSet elements)
        {
            ...
            ElementClassification elemClass = ClassifierService.ClassifyElement(target, SpecCulture.MasterFormat);
            string report = $@"Element: {target.Id}
    Classification System:  {elemClass.ClassificationSystem}
